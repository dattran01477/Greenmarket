      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example-2">
            <span class="sr-only">Cái gì đó không biết</span>
    ...
    <div class="wrapper">
        <div class="register-background" style="background: url('${pageContext.request.contextPath}/static/assets/paper_img/landscape.jpg')"> 
                        ...
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 ">
                            <div class="register-card">
                                ...
                                <u:form class="register-form" method="POST" action="j_spring_security_check" modelAttribute="refix">
                                    ...
                                    <u:input type="text" class="form-control" placeholder="Email" path="username" name="username"/>

                                    <label>Mật khẩu</label>
                                    <u:input type="password" class="form-control" name="password" placeholder="Password" path="password" />
            ...
            <div class="footer register-footer text-center">
                    <h6>&copy; 2019, made with <i class="fa fa-heart heart"></i> by BoooooooooooooM</h6>
            </div>
        </div>
    </div>      
